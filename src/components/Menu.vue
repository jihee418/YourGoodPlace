<template>
    <sui-menu
        ...
        <template v-for="menu in menuList">
            ...
            <!-- 하위 메뉴가 없는 메뉴 -->
            <router-link v-else is="sui-menu-item" :to="String(menu.url)">{{menu.name}}</router-link>
        </template>

        <!-- API 문서 사이트 -->
        <sui-menu-item :link="true">
            <a href="https://semantic-ui-vue.github.io/#/collections/menu" target="_blank">
                메뉴는 여기보고 만들었어요!
            </a>
        </sui-menu-item>
